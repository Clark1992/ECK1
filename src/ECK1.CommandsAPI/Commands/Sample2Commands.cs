...
public record ChangeSample2CustomerEmailCommand([property: FromRoute("id")] Guid Id, string NewEmail, int ExpectedVersion) : ISample2Command, IValueId<Guid>;

[GenerateSerializer]
[Route("PUT", "/api/async/sample2/{id}/shipping-address")]
public record ChangeSample2ShippingAddressCommand([property: FromRoute("id")] Guid Id, Address NewAddress, int ExpectedVersion) : ISample2Command, IValueId<Guid>;

[GenerateSerializer]
[Route("POST", "/api/async/sample2/{id}/line-items")]
public record AddSample2LineItemCommand([property: FromRoute("id")] Guid Id, Sample2Dto.LineItem Item, int ExpectedVersion) : ISample2Command, IValueId<Guid>;

[GenerateSerializer]
[Route("DELETE", "/api/async/sample2/{id}/line-items/{itemId}")]
[RequirePermissionAsync("delete")]
public record RemoveSample2LineItemCommand([property: FromRoute("id")] Guid Id, [property: FromRoute("itemId")] Guid ItemId, int ExpectedVersion) : ISample2Command, IValueId<Guid>;

[GenerateSerializer]
[Route("PUT", "/api/async/sample2/{id}/status")]
public record ChangeSample2StatusCommand([property: FromRoute("id")] Guid Id, Sample2Status NewStatus, string Reason, int ExpectedVersion) : ISample2Command, IValueId<Guid>;

[GenerateSerializer]
[Route("POST", "/api/async/sample2/{id}/tags")]
public record AddSample2TagCommand([property: FromRoute("id")] Guid Id, [property: FromQuery("tag")] string Tag, int ExpectedVersion) : ISample2Command, IValueId<Guid>;

[GenerateSerializer]
[Route("DELETE", "/api/async/sample2/{id}/tags")]
[RequirePermissionAsync("delete")]
public record RemoveSample2TagCommand([property: FromRoute("id")] Guid Id, [property: FromQuery("tag")] string Tag, int ExpectedVersion) : ISample2Command, IValueId<Guid>;
