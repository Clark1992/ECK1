...
/// <summary>
/// Configuration source that reads YAML manifest files from a directory,
/// parsing each file as a YAML document and mapping entries under
/// {SectionName}:{filename}:{key} in IConfiguration.
/// </summary>
public sealed class ManifestDirectoryConfigurationSource : IConfigurationSource
{
    public required string DirectoryPath { get; init; }
    public string SectionName { get; init; } = "IntegrationConfig";
